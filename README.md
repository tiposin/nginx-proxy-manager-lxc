...
```bash
curl -sL https://raw.githubusercontent.com/tiposin/nginx-proxy-manager-lxc/main/create.sh | bash -s
```
...
```bash
curl -sL https://raw.githubusercontent.com/tiposin/nginx-proxy-manager-lxc/main/create.sh | bash -s -- --cores 4
```
...
```bash
wget --no-cache -qO - https://raw.githubusercontent.com/tiposin/nginx-proxy-manager-lxc/main/setup.sh | sh
```
